...
root <- opt$root
setwd(paste(root, "data/11-14w/08_bladder/results", sep = "/"))
...
proj$tuned_label <- mapvalues(proj$clusters, from = paste0("C", 1:10),
                              to = c("Fibroblast", "Fibroblast", "Fibroblast", "Fibroblast", 
                                     "C5", "Glial", "Epithelial", "Epithelial-KRT5+", "Endothelial", "Immune(B)"))
