...
proj$tuned_ident <- mapvalues(proj$clusters, from = paste0("C", 1:10),
                              to = c("Fibro", "Fibro", "Fibro", "Fibro", "DPP6+", 
                                     "Glial", "Endo", "Immune", "Epi", "Epi-KRT5+"))
...
ery_cell_names <- static_choose_cell(proj, xlimit = c(6.58, 7.34), ylimit = c(12.78, 13.49))
...
plotMarker(proj, genes = c("DPP6"), do_plot = F)
dev.off()
