...
rownames(cellMetaData)[1:1152] = gsub("_Plate","",rownames(cellMetaData)[1:1152])
rownames(cellMetaData)[1:1152] = gsub("PD10_XXL_15_RC","RC_",rownames(cellMetaData)[1:1152])
rownames(cellMetaData)[1153:3072] = gsub("_Plate","_",rownames(cellMetaData)[1153:3072])
rownames(cellMetaData)[1153:3072] = gsub("P[RD]10_HCA_15_","",rownames(cellMetaData)[1153:3072])
