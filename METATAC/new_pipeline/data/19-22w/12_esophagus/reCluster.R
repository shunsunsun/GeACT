...
interactive_choose_cell(proj, c("ACTG2", "COL1A1"), log2Norm = T, group_bys = "tuned_label")

fibro_cell_names  <- static_choose_cell(proj, xlimit = c(-4.23, 7.44), ylimit = c(-3.67, 3.16), group_by = "tuned_label", used_groups = "Endo")

tuned_labels <- getCellColData(proj, select = "tuned_label")
tuned_labels[fibro_cell_names, ] <- "Fibro"
