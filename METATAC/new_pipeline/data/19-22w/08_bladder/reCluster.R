...
setwd(paste(root, "data/19-22w/08_bladder/results", sep = "/"))
...
proj$tuned_ident <- mapvalues(proj$clusters, from = paste0("C", 1:5),
                              to = c("Epi", "Glial", "Endo", "Fibro", "Fibro"))
...
immune_cell_names  <- static_choose_cell(proj, xlimit = c(-3.03, -1.95), ylimit = c(1.93, 3.74))
