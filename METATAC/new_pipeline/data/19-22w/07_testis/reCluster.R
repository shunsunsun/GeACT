...
proj$tuned_label <- mapvalues(proj$clusters, from = paste0("C", 1:8),
                              to = c("Fibro", "Fibro", "C3", "C4", "C5", 
...
interactive_choose_cell(proj, c("DAZL", "COL1A1", "MARCO"), log2Norm = T, group_bys = "tuned_label")
