...
proj$tuned_ident <- mapvalues(proj$clusters, from = paste0("C", 1:11),
                              to = c("Epi", "Epi", "Epi", "Macro", "B", 
                                     "T", "Erythrocyte", "Endo", "Glial", "Fibro", 
                                     "Fibro"))
...
# interactive_choose_cell(proj, c("EPCAM", "PLP1", "COL1A1", "COL2A1", "PECAM1", "MYH11"), log2Norm = T, group_bys = "tuned_ident")

un_cell_names  <- static_choose_cell(proj, xlimit = c(-1.71, 1.56), ylimit = c(-2.79, 0.29), group_by = "tuned_ident", used_groups = "Fibro")
