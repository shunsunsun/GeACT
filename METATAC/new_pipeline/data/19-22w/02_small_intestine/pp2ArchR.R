...
for(ct in c("SIU","SIM","SIL"))
{
  rownames(cellMetaData) <- gsub(paste("PD10_XXL_15",ct,"Plate",sep = '_'), paste(ct, '_', sep = ''), rownames(cellMetaData))
  rownames(cellMetaData) <- gsub("PD10_XXL_15_","", rownames(cellMetaData))
  rownames(cellMetaData) <- gsub("_Plate","",rownames(cellMetaData))
  rownames(cellMetaData) <- gsub(paste("PD10_HCA_15",ct,sep = '_'),paste(ct, '_', sep = ''),rownames(cellMetaData))
}
rownames(cellMetaData)[865:1152] = gsub("SIM","SIM_",rownames(cellMetaData)[865:1152])
rownames(cellMetaData)[1153:1344] = gsub("SIU","SIU_",rownames(cellMetaData)[1153:1344])
...
# pdf("Seurat_tSNE_UMAP_integration.pdf",width = 10,height = 6,useDingbats = F)
# 
# print(ggplot(cellMetaData, aes(x = tSNE_1, y = tSNE_2, color = predictedIdent)) + geom_point(size = 0.5) +
#         theme_cowplot() +
...
#         labs(color = NULL, x = "tSNE_1", y = "tSNE_2") +
#         guides(color = guide_legend(ncol = 1, override.aes = list(size = 3.6))))
# 
# print(ggplot(cellMetaData, aes(x = tSNE_1, y = tSNE_2, color = samplingPos)) + geom_point(size = 0.5) +
#         theme_cowplot() +
#         theme(legend.position = "right", legend.justification = c("center")) +
#         theme(aspect.ratio = 1, legend.box.margin = margin(t = -15), plot.margin = margin(t = 10, l = -20, r = 20)) +
#         theme(legend.key.width = unit(0.2, "cm")) +
...
#         guides(color = guide_legend(ncol = 1, override.aes = list(size = 3.6))))
# 
# print(ggplot(cellMetaData, aes(x = UMAP_1, y = UMAP_2, color = predictedIdent)) + geom_point(size = 0.5) +
#         theme_cowplot() +
#         theme(legend.position = "right", legend.justification = c("center")) +
#         theme(aspect.ratio = 1, legend.box.margin = margin(t = -15), plot.margin = margin(t = 10, l = -20, r = 20)) +
#         theme(legend.key.width = unit(0.2, "cm")) +
#         labs(color = NULL, x = "UMAP_1", y = "UMAP_2") +
#         guides(color = guide_legend(ncol = 1, override.aes = list(size = 3.6))))
# 
# print(ggplot(cellMetaData, aes(x = UMAP_1, y = UMAP_2, color = samplingPos)) + geom_point(size = 0.5) +
#         theme_cowplot() +
#         theme(legend.position = "right", legend.justification = c("center")) +
#         theme(aspect.ratio = 1, legend.box.margin = margin(t = -15), plot.margin = margin(t = 10, l = -20, r = 20)) +
#         theme(legend.key.width = unit(0.2, "cm")) +
...
#         guides(color = guide_legend(ncol = 1, override.aes = list(size = 3.6))))
# 
# print(ggplot(coembedMetaData, aes(x = tSNE_1, y = tSNE_2, color = orig.ident)) + geom_point(size = 0.5) +
#         theme_cowplot() +
#         theme(legend.position = "right", legend.justification = c("center")) +
#         theme(aspect.ratio = 1, legend.box.margin = margin(t = -15), plot.margin = margin(t = 10, l = -20, r = 20)) +
#         theme(legend.key.width = unit(0.2, "cm")) +
...
#         guides(color = guide_legend(ncol = 1, override.aes = list(size = 3.6))))
# 
# print(ggplot(coembedMetaData, aes(x = tSNE_1, y = tSNE_2, color = ident)) + geom_point(size = 0.5) +
#         theme_cowplot() +
#         theme(legend.position = "right", legend.justification = c("center")) +
#         theme(aspect.ratio = 1, legend.box.margin = margin(t = -15), plot.margin = margin(t = 10, l = -20, r = 20)) +
#         theme(legend.key.width = unit(0.2, "cm")) +
