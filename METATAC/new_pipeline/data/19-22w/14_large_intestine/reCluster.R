...
root <- opt$root
setwd(paste(root, "data/19-22w/14_large_intestine/results", sep = "/"))
...
interactive_choose_cell(proj, c("PECAM1"), log2Norm = T, group_bys = "tuned_label")

un_cell_names  <- static_choose_cell(proj, xlimit = c(-0.17, 1.64), ylimit = c(-5.53, -3.36), group_by = "tuned_label", used_groups = "Endo")
