...
proj <- addClusters(proj, reducedDims = "peakLSI", name = "clusters", dimsToUse = 1:30, force = T, k.param = 5, prune.SNN = 1/15, resolution = 0.05)
...
proj$tuned_label <- mapvalues(proj$clusters, from = paste0("C", 1:8),
                              to = c("Glial", "Fibro", "Fibro", "SKM", "Endo", 
                                     "MT1DP+", "Immune", "Epi-like"))
