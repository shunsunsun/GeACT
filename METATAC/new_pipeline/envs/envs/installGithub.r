...
doc <- "Usage: installGithub.r [-l LIBLOC] [-h] [-x] [-d DEPS] [-u UPDATE] [-r REPOS...] [--timeout TIMEOUT] [-b BIOMIRROR] [--] [GHREPOS...]

-l --libloc LIBLOC  location in which to install [default: /usr/local/lib/R/site-library]
-d --deps DEPS       install suggested dependencies as well? [default: NA]
-u --update UPDATE   update dependencies? [default: FALSE]
-r --repos REPOS     repositor(y|ies) to use if deps required [default: getOption]
-t --timeout TIMEOUT timeout in seconds [default: 180]
-b --biomirror BIOMIRROR  Bioconductor Mirror for bioconductor to use [default: getOption]
...
if (opt$biomirror != "getOption"){
  options(BioC_mirror=opt$biomirror)
}
...
invisible(sapply(opt$GHREPOS, function(r) install_github(r, dependencies = opt$deps, lib = opt$libloc, upgrade = opt$update, repos = opt$repos)))
