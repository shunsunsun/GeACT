...
cat("Effective plate number:", length(unique(cellMeta_ftd$plate)), "\n")
cat("Effective cell number (before filtering):", 96 * length(unique(cellMeta_ftd$plate)), "\n")
cat("Position number:", nrow(unique(cellMeta_ftd[, c("tissue", "samplingPos")])), "\n")
cat("Ident number:", nrow(unique(subset(cellMeta_ftd, ident != "Unknown", c("tissue", "ident")))), "\n")
