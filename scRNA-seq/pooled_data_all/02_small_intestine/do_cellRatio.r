...
cellMetaData[cellMetaData$samplingPos %in% c("middle section", "lower section"), "samplingPos"] <- "middle/lower section"
...
cellMetaData$samplingPos <- factor(cellMetaData$samplingPos, levels = c("Upper section", "Middle/lower section"))
