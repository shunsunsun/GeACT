...
setwd("~/lustre/06-Human_cell_atlas/issues/cell_barcodes/02_0x96/")
...
library("pheatmap")
pheatmap(mat = inner_dist_MT, cluster_rows = F, cluster_cols = F, 
         show_rownames = F, show_colnames = F, 
         color = c("red", colorRampPalette(c("purple", "blue"))(5)), breaks = 1:7, 
         display_numbers = F, number_format = "%d", fontsize_number = 14, number_color = "black")
dev.off()
