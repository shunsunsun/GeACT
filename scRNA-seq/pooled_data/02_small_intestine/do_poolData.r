...
setwd("~/lustre/06-Human_cell_atlas/pooled_data/02_small_intestine/")

library("parallel")

# options
dts <- data.frame(seqid = c("14_D2_44","15_D1_48","15_D1_48","15_D1_48","16_D1P1_48"), posid = c("XCZ_C","XCS_C","XCX_C","XCZ_C","XCX_C"), stringsAsFactors = F)
#out <- "X"
