...
STAR --runThreadN $cpu --genomeDir $IN2/$bpp/STAR_index --readFilesIn \$read --readFilesCommand zcat --outSAMtype BAM SortedByCoordinate --outFileNamePrefix $OUT/$bpp/$id/ --outTmpDir $OUT/$bpp/$id/STARtmp/ --outSAMunmapped Within
mv $OUT/$bpp/$id/Aligned.sortedByCoord.out.bam $OUT/$bpp/$id/${id}_sorted.bam
